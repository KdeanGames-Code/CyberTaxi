...
router.get(
    ...
    createProxyMiddleware({
        ...
        timeout: 0, // Infinite for dev to avoid 504
        proxyTimeout: 0,
        ...
        onProxyRes: (proxyRes, req, res) => {
            ...
            if (proxyRes.statusCode === 404) {
                // Fallback to empty PNG for missing tiles
                res.set("Content-Type", "image/png");
                res.send(
                    Buffer.from(
                        "",
                        "base64"
                    )
                );
            }
